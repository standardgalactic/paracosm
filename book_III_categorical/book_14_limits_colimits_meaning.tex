...
\chapter*{Appendix A: Proofs of Limit/Colimit Existence Theorems in $\mathbf{RSVPField}$}
\addcontentsline{toc}{chapter}{Appendix A: Proofs of Limit/Colimit Existence Theorems in $\mathbf{RSVPField}$}

Existence of limits and colimits in $\mathbf{RSVPField}$ for diagrams of a given shape $I$ is established here by verifying that $\mathbf{RSVPField}$ is complete and cocomplete with respect to the relevant class of diagrams, following the standard construction of limits and colimits as equalizers of products and coequalizers of coproducts respectively, adapted to the curvature-preserving morphisms Book 11's Chapter 2 defined; the entropy-defect obstruction of Chapter 4 identifies exactly the cases in which this standard construction fails to produce a genuine object of $\mathbf{RSVPField}$, rather than merely an object of the underlying category without its curvature-preserving structure.

\chapter*{Appendix B: Examples of Partial and Total Gluing in Real Datasets}
\addcontentsline{toc}{chapter}{Appendix B: Examples of Partial and Total Gluing in Real Datasets}
...
\chapter*{Appendix C: Correspondence Between Categorical and Sheaf-Theoretic Closure}
\addcontentsline{toc}{chapter}{Appendix C: Correspondence Between Categorical and Sheaf-Theoretic Closure}
...
\chapter*{Appendix D: Reflective Note --- ``To Know Together Is to Form a Limit''}
\addcontentsline{toc}{chapter}{Appendix D: Reflective Note --- ``To Know Together Is to Form a Limit''}
